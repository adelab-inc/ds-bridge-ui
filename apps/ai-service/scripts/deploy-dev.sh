...
deploy_simple() {
    ...
    [ -n "${X_EXTERNAL_KEY}" ] && ENV_VARS="${ENV_VARS}@X_EXTERNAL_KEY=${X_EXTERNAL_KEY}"
    ...
    # Figma API
    [ -n "${FIGMA_PERSONAL_ACCESS_TOKEN}" ] && ENV_VARS="${ENV_VARS}@FIGMA_PERSONAL_ACCESS_TOKEN=${FIGMA_PERSONAL_ACCESS_TOKEN}"
    [ -n "${FIGMA_DESIGN_SYSTEM_URL}" ] && ENV_VARS="${ENV_VARS}@FIGMA_DESIGN_SYSTEM_URL=${FIGMA_DESIGN_SYSTEM_URL}"
