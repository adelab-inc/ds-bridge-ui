...
9. 데이터 정책: 대화에서 DB 종류, 삭제 방식, 수정 규칙이 언급되었으면 "데이터 정책" 섹션을 반드시 작성하세요
10. AS-IS 매핑: 대화에서 기존 테이블/컬럼 매핑이 언급되었으면 "AS-IS → TO-BE 데이터 매핑" 섹션을 반드시 작성하세요
