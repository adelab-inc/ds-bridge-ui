    ...
    <div className="bg-canvas p-8">
      <GridLayout type="C">
        ...
        <div className="sticky top-8 h-fit">
          <TitleSection title="보플 PUSH 발송" favorite={false} onFavoriteChange={() => {}} showBreadcrumb={false} />
          ...
          <div className="mt-5 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2 pt-2">
              ...
              <div className="mt-4">
                <Button buttonType="tertiary" size="lg" label="전체화면 닫기" onClick={() => window.history.back()} className="w-full" />
              </div>
            </div>
          </div>
        </div>
