...
FIREBASE_DIR = Path(__file__).parent.parent / "database"
OUTPUT_DIR = Path(__file__).parent.parent / "python" / "database"
...
'''.format(entries="\n".join(entries))
    ...
    print("✅ Generated: python/database/collections.py")
...
'''.format(type_defs="\n\n".join(type_defs))
    ...
    print("✅ Generated: python/database/types.py")
...
'''.format(entries="\n".join(entries))
    ...
    print("✅ Generated: python/database/storage.py")
...
__all__ = ["Tables", "StoragePaths", {all_exports}]
'''.format(
        type_imports=type_imports,
        all_exports=", ".join(f'"{name}"' for name in ["Tables", "StoragePaths"] + type_exports)
    )

    with open(OUTPUT_DIR / "__init__.py", "w") as f:
        f.write(output)

    print("✅ Generated: python/database/__init__.py")
