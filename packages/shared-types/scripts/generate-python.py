...
'''.format(entries="\n".join(entries))
    ...
    print("✅ Generated: python/firebase/collections.py")
...
'''.format(type_defs="\n\n".join(type_defs))
    ...
    print("✅ Generated: python/firebase/types.py")
...
'''.format(entries="\n".join(entries))
    ...
    print("✅ Generated: python/firebase/storage.py")
...
'''.format(
    ...
    print("✅ Generated: python/firebase/__init__.py")
