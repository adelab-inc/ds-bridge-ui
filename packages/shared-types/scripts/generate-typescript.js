...
const FIREBASE_DIR = path.join(__dirname, '../database');
const OUTPUT_DIR = path.join(__dirname, '../typescript/database');
...
/**
 * JSON type to TypeScript type 변환
 */
...
function generateCollections() {
  ...
  const hasTimestamp = JSON.stringify(collectionsJson).includes(
    '"type": "timestamp"'
  );
  const timestampImport = hasTimestamp
...
${timestampImport}export const TABLES = {
${entries}
} as const;
...
`;
  ...
  console.log('✅ Generated: typescript/database/collections.ts');
}
...
`;
  ...
  console.log('✅ Generated: typescript/database/types.ts');
}
...
`;
  ...
  console.log('✅ Generated: typescript/database/storage.ts');
}
...
`;
  ...
  console.log('✅ Generated: typescript/database/index.ts');
}
